...
def main():
    ...
    if args.bg_upsampler == 'realesrgan':
        if not torch.cuda.is_available() or not torch.backends.mps.is_available():  # CPU
            import warnings
    ...
    model_path = os.path.join('Wav2Lip/GFPGAN-master/experiments/pretrained_models', model_name + '.pth')
